...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIStoryboard *feedsSB = [UIStoryboard storyboardWithName:@"Feeds" bundle:nil];
    UINavigationController *feedsNavVC = [feedsSB instantiateInitialViewController];
    feedsNavVC.title = @"News";
    //feedsNavVC.tabBarItem.image = [UIImage imageNamed:@"first.png"];
